...
df <- read.csv("E:\\work\\q_backup_06_03_2025\\projects\\isttc\\results\\synthetic\\results\\param_fr_alpha_tau_comp_time\\full_signal\\compute_time_full_long_df_all_units.csv", 
...
str(df)
table(df$method)
#summary(df$elapsed_time_acf_sec)
...
p10 <- p + scale_y_continuous(limits = c(-0.01, 0.3))
p10
